    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            {               
                ...
                if (bossBashCheck == false && bossBashChance<= bossBashChanceThreshhold)
                ...
                {                    
                    case "5":
                        ...
                        {
                            deadManAlive = false;
                            Console.WriteLine("Ваш мертвец погибли.");
                        }
                    ...
                    case "6":
                        ...
                        if ((counterAttack > counterAttackTreshold && bossBashChance <= bossBashChanceThreshhold) && bossBashCheck==false)
                        {
