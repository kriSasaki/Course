...
namespace _19
{
    class Program
    {
            ...
            while (isOn)
            {
                ...
                switch (command)
                {
                    ...
                    case 3:
                        ...
                        DeleteDossier(ref fullNames, delete, ref isDossierFound);
                        DeleteDossier(ref positions, delete, ref isDossierFound);
                        break;
                    case 4:
                        SearchDossier(ref fullNames, ref positions, isDossierFound);
                        break;
                    case 5:
                        isOn = false;
                        break;
        ...
        static void DeleteDossier(ref string[] array,int delete, ref bool isDossierFound)
        {
        ...
        static void SearchDossier(ref string[] fullNames, ref string[] positions, bool isDossierFound)
        {
